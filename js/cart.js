...
<div class="cart-item">
    ...
    if (itemsprices) {
        ...
        const shipping = subtotal >= 2000 ? 0 : 50.00; // Free shipping over $50
        ...
        <div class="price-summary">
            ...
            <div class="price-breakdown">
                ...
                <div class="price-row">
                    <span>Shipping</span>
                    <span>${subtotal >= 2000 ? '<em style="color:#016601;">FREE</em>' : '₹50.00'}</span>
                </div>
            ...
            ${subtotal > 2000 ? '' : `
                <p class="free-shipping-note">
                    <em>Add <strong>₹${(2000 - (subtotal + tax)).toFixed(2)}</strong> more for <strong>FREE shipping</strong>!</em>
                </p>
            `}
        </div>
    `;
